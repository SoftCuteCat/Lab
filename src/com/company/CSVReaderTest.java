...
class CSVReaderTest {
    ...
    void test2() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/2.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test3() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/3.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test4() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/4.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test5() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/5.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test6() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/6.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test7() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/7.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test8() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/8.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test9() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/9.csv");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
    ...
    void test10() throws Exception{
        csv = new CSVReader("/home/evgeny/Documents/university/Java/Lab4/1.txt");
        Exception exception = assertThrows(Exception.class, () -> csv.reading());
